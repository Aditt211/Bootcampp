...
<div class="modal fade" id="detailStudentModal" tabindex="-1" aria-labelledby="detailStudentModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="studentDetails" class="row">
                    <!-- Gambar Mahasiswa di Kiri -->
                    <div class="col-md-4 text-center">
                        <img id="studentPhoto" src="" alt="Foto Mahasiswa" class="img-fluid rounded">
                    </div>
                    <!-- Data Mahasiswa di Kanan -->
                    <div class="col-md-8">
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <p><strong>Tempat Lahir:</strong> <span id="studentBirthplace"></span></p>
                        </div>
                        <div class="mb-2">
                            <p><strong>Tanggal Lahir:</strong> <span id="studentBirthdate"></span></p>
                        </div>
                        <div class="mb-2">
                            <p><strong>Jenis Kelamin:</strong> <span id="studentGender"></span></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    fetch(`/students/${id}`)
        ...
        .then(data => {
            // Memuat gambar
            document.getElementById('studentPhoto').src = `/storage/${data.foto}`;
            
            // Memuat data mahasiswa
            document.getElementById('studentNim').textContent = data.nim;
            document.getElementById('studentName').textContent = data.nama;
            document.getElementById('studentBirthplace').textContent = data.tempat_lahir;
            document.getElementById('studentBirthdate').textContent = data.tanggal_lahir;
            document.getElementById('studentGender').textContent = data.jenis_kelamin;

            // Mengubah aksi form delete dengan ID mahasiswa
